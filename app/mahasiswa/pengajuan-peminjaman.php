    ...
    <div class="container-fluid page-body-wrapper">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a href="pengajuan-peminjaman.php" style="color:yellow; background-color:#4B49AC;" class="nav-link">pengajuan Peminjaman</a>
          </li>
          <li class="nav-item">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <a class="btn btn-sm btn-info mb-2" href="index.php">Ajukan Peminjaman</a>
          <div class="row">
