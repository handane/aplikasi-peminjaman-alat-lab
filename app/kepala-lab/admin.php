   ...
   <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
         <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center" style="background-color: rgba(255,245,0,1); border-bottom: solid grey">
            ...
            <h3 class="title" style="color:rgba(2,11,133,1);">Kepala Lab</h3>
         </div>
      ...
      <div class="container-fluid page-body-wrapper">
         <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
               <li class="nav-item">
                  <a href="index.php" class="nav-link">Daftar Peminjaman </a>
               </li>
               <li class="nav-item">
                  <a href="admin.php" class="nav-link" style="color:yellow; background-color:#4B49AC;">Data Admin</a>
               </li>
            </ul>
         </nav>
         <!-- partial -->
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <button type="button" class="btn btn-sm btn-info" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Tambah Admin</button>
                                 ...
                                 <tbody>
                                    ...
                                    ?>
                                          <tr>
                                             ...
                                             <td><a href="hapus-admin.php?id_admin=<?php echo $row['id_admin']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin ingin menghapus admin <?php echo $row['nama'] ?>')">Hapus Akun</a></td>
                                          </tr>
                                    <?php }
                                    } ?>
                                 </tbody>
                  ...
                  <div class="modal-content">
                     ...
                     <form method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                           <div class="mb-1">
                              <input type="text" class="form-control mt-1" id="recipient-name" autocomplete="off" name="nip_baru" placeholder="NIP">
                              ...
                              <select name="jeniskelamin_baru" class="form-control mt-3" id="">
